...
parser.add_argument("--model_name", default="v5.4_dense_dropout2_lr3_fine_tuned", type=str, help="Name of the model to train/test")
parser.add_argument("--batch_size", default=100, type=int, help="Batch size.")  # TODO
parser.add_argument("--epochs", default=100, type=int, help="Number of epochs.")
parser.add_argument("--seed", default=42, type=int, help="Random seed.")
parser.add_argument("--threads", default=12, type=int, help="Maximum number of threads to use.")
parser.add_argument("--training", default=False, type=bool, help="Whether to train the model")
parser.add_argument("--fine_tuning", default=False, type=bool, help="Whether to fine_tune the model")
...
def main(args: argparse.Namespace) -> None:
    ...
    fine_tuning_top = args.fine_tuning_top
    ...
    if training:
        ...
        #     print("showing plot")
        #     for i in range(max(25, args.batch_size)):
    ...
    if training:
        if not (fine_tuning or fine_tuning_top):
            ...
            # x = k.layers.Dropout(rate=0.1)(x)
            # x = k.layers.Dense(640, activation=k.activations.swish,
            ...
            outputs = k.layers.Dense(len(CAGS.LABELS),
                                     activation=k.activations.softmax,
                                     kernel_regularizer=k.regularizers.l2(0.0001),
                                     bias_regularizer=k.regularizers.l2(0.0001),
                                     name="vyhodnoceni_cags")(x)
        ...
        model.compile(optimizer=k.optimizers.Adam(learning_rate=learning_rate),
                      ...
                      metrics=[k.metrics.CategoricalAccuracy("accuracy")])
        ...
        es_callback = k.callbacks.EarlyStopping(monitor='val_loss', min_delta=0.01, mode='min', verbose=1, patience=10)
        ...
        print("Saving model...")
        if fine_tuning:
            model.save("./models/" + model_name + "_fine_tuned")
